    ...
    <>
      ...
      >
        <div className="max-w-[1440px] mx-auto flex items-center justify-between">
          ...
          <Link href="/contact">
            <div className="flex items-center gap-4 px-4 py-2 border border-[#575757] hover:border-white/40 transition-colors bg-black/40 backdrop-blur-sm cursor-pointer select-none text-white font-mono text-[14px] tracking-normal rounded-none h-[44px]">
              <span className="hidden sm:inline">Book a call</span>
              <span className="sm:hidden">Book</span>
              <div className="relative flex items-center pr-1.5 select-none pointer-events-none">
                {/* Avatar */}
                <div className="relative w-[28px] h-[28px] rounded-full overflow-hidden border border-white/10 shrink-0">
                  <Image 
                ...
                <div className="absolute -right-2.5 top-1/2 -translate-y-1/2 w-[18px] h-[18px] rounded-full bg-[#33FF0D] flex items-center justify-center text-black border border-black/10 z-10 shadow-[0_0_8px_rgba(51,255,13,0.3)]">
