    ...
    <main className="bg-bg-primary min-h-screen">
      ...
      <section className="pt-40 pb-20 px-6 md:px-12">
        <div className="max-w-[1200px] mx-auto text-center">
          ...
          <Reveal delay={0.2}>
            <h1 className="text-[60px] md:text-[90px] font-medium leading-[1.1] tracking-tight mb-8">
                    ...
                    <div className="px-4 space-y-4">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                          ...
                          <h2 className="text-[32px] md:text-[40px] font-medium tracking-tight group-hover:text-brand-main transition-colors">{project.title}</h2>
                        </div>
