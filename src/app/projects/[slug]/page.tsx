    ...
    <main className="bg-bg-primary min-h-screen">
      ...
      <section className="pt-40 pb-20 px-6 md:px-12">
        <div className="max-w-[1200px] mx-auto">
          ...
          <Reveal delay={0.2}>
            <h1 className="text-[60px] md:text-[100px] font-medium leading-[1] tracking-tighter mb-12 max-w-4xl">
              {project.title}
            </h1>
          </Reveal>
            ...
            <div className="lg:col-span-8 space-y-24">
              <RevealItem delay={0.2}>
                <div className="space-y-8">
                  <h2 className="text-[40px] md:text-[56px] font-medium tracking-tight">The Challenge</h2>
              ...
              <RevealItem delay={0.3}>
                <div className="space-y-8">
                  <h2 className="text-[40px] md:text-[56px] font-medium tracking-tight">Our Solution</h2>
                  <p className="text-[20px] text-text-muted leading-relaxed">
              ...
              <RevealItem delay={0.35}>
                <div className="space-y-8 p-10 md:p-12 rounded-[40px] bg-white/[0.02] border border-white/5">
                  ...
                  <p className="text-[24px] md:text-[32px] font-medium leading-tight tracking-tight italic text-text-heading pr-2">
                    {project.designStyle}
                  </p>
                </div>
              </RevealItem>
              ...
              <RevealItem delay={0.4}>
                <div className="space-y-10 p-10 md:p-16 rounded-[40px] bg-brand-main/5 border border-brand-main/20 relative overflow-hidden group">
                  ...
                  <div className="relative z-10 space-y-6">
                    <h2 className="text-[40px] md:text-[56px] font-medium tracking-tight text-brand-main">The Impact</h2>
                    <p className="text-[22px] md:text-[28px] font-medium leading-relaxed text-white">
      ...
      <section className="px-6 md:px-12 pb-40">
        <div className="max-w-[1200px] mx-auto pt-20 border-t border-white/5">
          <Link href="/projects" className="group block text-center space-y-4">
            ...
            <h2 className="text-[40px] md:text-[60px] font-medium group-hover:italic transition-all duration-500">Explore All <span className="gradient-text pr-[0.1em]">Projects</span></h2>
          </Link>
        </div>
      </section>
