  ...
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <section className="relative min-h-[70vh] flex flex-col items-center justify-center pt-40 pb-24 px-6 overflow-hidden bg-black border-b border-white/5">
        ...
        {/* Background glow */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-[#33FF0A]/4 blur-[180px] rounded-full pointer-events-none" />
        ...
        >
          ...
          <h1 className="font-display text-[56px] sm:text-[80px] md:text-[100px] lg:text-[120px] text-white leading-[1.0] tracking-normal uppercase mb-10">
            BUILT TO<br />
            <span className="text-[#33FF0A]">COMMUNICATE.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-center justify-center">
            <Link href="/contact" className="relative group block">
              ...
              <div className="flex items-center bg-[#33FF0A] text-black font-mono text-[12px] uppercase tracking-[0.15em] h-[52px] px-8 hover:bg-[#33FF0A] hover:shadow-[0_8px_20px_rgba(51,255,10,0.2)] hover:-translate-y-0.5 transition-all duration-300 cursor-pointer border-none font-semibold rounded-none relative z-10">
        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <Reveal>
            <div className="flex items-center gap-6 mb-20">
              <span className="font-mono text-[#33FF0A] text-[11px] uppercase tracking-[0.3em]">// 04 services</span>
          ...
          <div className="space-y-0">
            {services.map((service, i) => (
              <Reveal key={service.id} delay={i * 0.1}>
                <div className={`group grid grid-cols-1 lg:grid-cols-12 gap-0 border-t border-[#575757]/20 py-16 md:py-20 hover:border-[#33FF0A]/30 transition-colors duration-500 ${i === services.length - 1 ? 'border-b border-[#575757]/20' : ''}`}>

                  {/* Left: number + title */}
                  <div className="lg:col-span-5 flex flex-col justify-between mb-10 lg:mb-0 pr-0 lg:pr-16">
                    <div>
                      <div className="flex items-center gap-4 mb-6">
                        <span className="font-mono text-[#33FF0A] text-[11px] tracking-[0.2em]">[ {service.id} ]</span>
                  ...
                  <div className="lg:col-span-5 flex flex-col justify-center mb-10 lg:mb-0 pr-0 lg:pr-8">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {service.tags.map((tag, j) => (
                        <span
                          key={j}
                          className="font-mono text-[10px] uppercase tracking-[0.12em] text-[#505250] border border-[#575757]/25 px-3 py-1.5 group-hover:border-[#33FF0A]/20 group-hover:text-[#A4A4A4] transition-all duration-300"
                        >
                          {tag}
                        </span>
                      ))}
                  ...
                  <div className="lg:col-span-2 flex items-center justify-start lg:justify-end">
                    <motion.div
                      ...
                      className="relative w-20 h-20 md:w-28 md:h-28 filter drop-shadow-[0_10px_30px_rgba(51,255,10,0.08)] group-hover:drop-shadow-[0_15px_40px_rgba(51,255,10,0.2)] transition-all duration-500"
                    >
                      <Image
                        src={service.icon}
                        alt={service.title}
        ...
        <div className="max-w-[1200px] mx-auto relative z-10">
          ...
          <Reveal>
            <div className="flex items-center gap-6 mb-6">
              <span className="font-mono text-[#33FF0A] text-[11px] uppercase tracking-[0.3em]">// How we work</span>
              <div className="flex-1 h-px bg-white/5" />
            </div>
            <h2 className="font-display text-[48px] sm:text-[68px] md:text-[80px] text-white leading-[1.0] tracking-normal uppercase mb-6">
              A CLEAR PROCESS.<br />
              <span className="text-[#33FF0A]">NO GUESSWORK.</span>
            </h2>
          ...
          <div className="space-y-0">
            {steps.map((step, i) => (
              <Reveal key={step.number} delay={i * 0.08}>
                <div className={`grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-0 border-t border-[#575757]/20 py-10 md:py-12 group hover:border-[#33FF0A]/20 transition-colors duration-300 ${i === steps.length - 1 ? 'border-b border-[#575757]/20' : ''}`}>
                  <div className="md:col-span-1">
                    <span className="font-mono text-[#33FF0A] text-[12px] tracking-[0.2em]">[ {step.number} ]</span>
                  </div>
                  ...
                  <div className="md:col-span-1 flex items-center justify-end">
                    <span className="text-[#33FF0A] opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-[20px]">→</span>
                  </div>
                </div>
              </Reveal>
            ))}
          ...
          <Reveal delay={0.3}>
            <div className="mt-16 pt-10 border-t border-white/5 flex items-center gap-4">
              <div className="w-2 h-2 bg-[#33FF0A] rotate-45 shrink-0" />
          ...
          <Reveal>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-0 border border-[#575757]/20">
              {[
                ...
                >
                  {plan.featured && (
                    <div className="absolute top-0 left-0 right-0 h-[2px] bg-[#33FF0A]" />
                  )}
                  <div className="flex items-start justify-between mb-8">
                    <div>
                      <span className="font-mono text-[#505250] text-[10px] uppercase tracking-[0.2em] block mb-2">[ {plan.id} ]</span>
                      <span className="font-mono text-[#33FF0A] text-[11px] uppercase tracking-[0.2em]">{plan.name}</span>
                    </div>
                  ...
                  <span className="font-mono text-[11px] uppercase tracking-[0.15em] text-[#505250] group-hover:text-[#33FF0A] transition-colors duration-300 flex items-center gap-2">
      ...
      <section className="py-32 md:py-48 px-6 bg-black relative overflow-hidden">
        <div className="absolute top-0 left-0 w-[600px] h-[600px] bg-[#33FF0A]/5 blur-[180px] rounded-full pointer-events-none" />
        <div className="absolute bottom-0 right-0 w-[400px] h-[400px] bg-[#33FF0A]/3 blur-[120px] rounded-full pointer-events-none" />
        ...
        <div className="max-w-[1200px] mx-auto relative z-10 text-center">
          ...
          <motion.div
            ...
            className="relative w-16 h-32 md:w-20 md:h-40 mx-auto overflow-hidden filter drop-shadow-[0_15px_30px_rgba(51,255,10,0.2)] -mb-8"
          >
          ...
          <Reveal delay={0.2}>
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-center">
              <Link href="/contact" className="relative group block">
                ...
                <span className="absolute bottom-[-5px] left-[-5px] w-2 h-2 border-b border-l border-white opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-20" />
                <span className="absolute bottom-[-5px] right-[-5px] w-2 h-2 border-b border-r border-white opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-20" />
                <div className="flex items-center bg-[#33FF0A] text-black font-mono text-[12px] uppercase tracking-[0.15em] h-[52px] px-8 hover:bg-[#33FF0A] hover:shadow-[0_8px_20px_rgba(51,255,10,0.2)] hover:-translate-y-0.5 transition-all duration-300 cursor-pointer font-semibold rounded-none relative z-10">
                  <span className="mr-4">Start your project</span>
                  <span className="inline-block transform -rotate-45 group-hover:rotate-0 transition-transform duration-300 text-[16px] leading-none">→</span>
                </div>
              </Link>
              ...
              <Link href="/contact" className="relative group block">
                <div className="flex items-center gap-3 bg-black text-white border border-[#575757] hover:border-white/40 font-mono text-[12px] uppercase tracking-[0.15em] h-[52px] px-8 hover:bg-white/5 hover:shadow-[0_8px_20px_rgba(255,255,255,0.05)] hover:-translate-y-0.5 transition-all duration-300 cursor-pointer rounded-none relative z-10">
                  ...
                  <div className="w-[18px] h-[18px] rounded-full bg-[#33FF0A] flex items-center justify-center text-black border border-black/10 shadow-[0_0_8px_rgba(51,255,10,0.3)] transition-all duration-300 group-hover:scale-110 group-hover:rotate-[15deg] shrink-0">
